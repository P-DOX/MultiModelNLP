...
class DocSimilarity(forms.Form):
    algorithmChoices= [
    ('cosineSimilarity', 'Cosine Similarity'),
    ('tfIDF', 'TF-IDF'),
    ('neuralNetwork', 'Neural Network')
    ]
    data1 = forms.CharField(widget=forms.Textarea)
    data2 = forms.CharField(widget=forms.Textarea)
    algorithm = forms.CharField(label='Algorithm', widget=forms.Select(choices=algorithmChoices))
